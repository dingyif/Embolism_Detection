...
if tiff_paths:
    ...
    if match:
        real_start_img_idx = int(match.group('start_img_idx'))
        real_end_img_idx = int(match.group('end_img_idx')) + 1
        print(real_start_img_idx)
        print(real_end_img_idx)
        ...
        if is_save==True:
            ...
            chunk_folder = os.path.join(img_folder,str(chunk_idx)+'_'+str(start_img_idx)+'_'+str(end_img_idx))
