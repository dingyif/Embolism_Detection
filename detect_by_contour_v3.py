...
for img_idx in range(0,bin_stack.shape[0]):
    ...
    final_stack1[img_idx,:,:] = find_emoblism_by_contour(bin_stem_stack,img_idx,stem_area=stem_area,final_area_th = final_area_th,area_th=area_th, area_th2=area_th2,ratio_th=35,e2_sz=1,o2_sz=2,cl2_sz=2,plot_interm=False,shift_th=shift_th,density_th=density_th,num_px_th=num_px_th)
