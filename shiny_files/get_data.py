# -*- coding: utf-8 -*-
"""
Created on Mon Apr 20 17:42:57 2020
...
img_folder_rel = 'F:/ProcessedImages_0221/stem'
#top directory that stores the folders w/raw image, for getting img filenames and true tif (if use_predict_tif==False)
has_processed = True
disk_path = 'F:/ProcessedImages_0221/stem'#'F:/server_output/processed/v11' 
...
folder_idx_start = 0
folder_idx_end = 8
#run folders from folder_idx_start to folder_idx_end(include)
