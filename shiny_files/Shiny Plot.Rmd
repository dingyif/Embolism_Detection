  ...
  # Application title
    ...
    sidebarLayout(
        ...
        mainPanel(
            ...
            conditionalPanel(condition = "input.plot_name != 'Plotly'", plotOutput("plot")),
...
server <- function(input, output) {
  ...
  emb_num_list <- reactive({embolism_table[(input$time*60-embolism_table$`time_since_start(mins)`)>0,"number_emb"]})
